// DMA ile çoklu ADC okumasý yapýlacak

#include "stm32f4xx.h"
#include "stm32f4_discovery.h"

#define BufferLength 2 // Burasý 2 veya daha fazla olur

// Çoklu ADC uygulamasýna binaen dizi oluþturuldu
// mesela 3 ADC okuma yapýlýrsa dizinin içine 3 yazýlýr.
uint16_t adc_value[BufferLength] = {0, 0}; // 2 tane okuma yazýlýr. ADC'lerin baþlangýç deðerleri 0 olsun.
...
void GPIO_Config()
{
	...
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL; // Default bu geliyor zaten
...
void ADC_Config()
{
	...
	// saða yaslý mý sola yaslý mý olduðunu düþünüyoruz. Saða yaslayarak yazdýrýyoruz.
	...
	ADC_DMARequestAfterLastTransferCmd(ADC1, ENABLE); // Ýki ADC'miz de ADC1
